...
namespace COMP003B.Assignment7.Controllers
{
    public class MovieActorController : Controller
    {
        ...
        public MovieActorController(MvcMovieContext context)
        {
            _context = context;
        }
        ...
        {
            var mvcMovieContext = _context.MovieActor.Include(m => m.Actor).Include(m => m.Movie);
        ...
        {
            ViewData["ActorId"] = new SelectList(_context.Actor, "ActorId", "Email");
        ...
        public async Task<IActionResult> Create([Bind("Id,MovieId,ActorId")] MovieActor movieActor)
        {
            ...
            ViewData["ActorId"] = new SelectList(_context.Actor, "ActorId", "Email", movieActor.ActorId);
            ViewData["MovieId"] = new SelectList(_context.Movie, "MovieId", "Title", movieActor.MovieId);
            return View(movieActor);
        }
